...
# 4. Record start time
echo "Started: $(date -Iseconds)" >> data/transcripts/treatment-0a/notes.md
```
...
```
git diff > data/patches/treatment-0a/<FN>.patch
...
# 3. Record end time
echo "Ended: $(date -Iseconds)" >> data/transcripts/treatment-0a/notes.md
